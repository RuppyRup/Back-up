...
def populateDirectorySystemTreeStore(treeStore, path, parent=None):
    itemCounter = 0
    # iterate over the items in the path
    for item in os.listdir(path):
        # Get the absolute path of the item
...
def onRowExpanded(treeView, treeIter, treePath):
    ...
    populateDirectorySystemTreeStore(treeStore, newPath, treeIter)
...
populateDirectorySystemTreeStore(fileSystemTreeStore, '/home/rupert/Documents')
